...
e2e/                 — Playwright E2E tests
  ...
  screenshot.spec.js — generates docs/screenshot.png (README image); on-demand, not in CI
  panel-harness.js   — shared mock-chrome harness (setupPanel/sendPortMessage/fireRequestFinished) used by panel + screenshot specs
...
docs/screenshot.png  — README hero image (committed; regenerate via npm run screenshot)
